...
namespace KomMee_Tests
{
    public partial class MessageListViewTest : Form
    {
        public MessageListViewTest()
        {
            ...
            data.Rows.Add(0, "bla hkjsdf ansdljsd nlkddmsm", "123456789", 12, 0, 1, "12-08-2012 21:18");
            for (int i = 0; i < data.Rows.Count; i++)
            {
                msgList.Add(new SMSMessage(data));
            }
            ...
            data.Rows.Add(0, "bla hkjsdf ansdljsd nlkddmsm", "123456789", 12, 0, 1, "12-08-2011 21:18");
            for (int i = 0; i < data.Rows.Count; i++)
            {
                msgList.Add(new SMSMessage(data));
            }
            ...
            data.Rows.Add(0, "bla hkjsdf ansdljsd nlkddmsm", "123456789", 12, 0, 1, "12-08-2013 21:18");
            for (int i = 0; i < data.Rows.Count; i++)
            {
                msgList.Add(new SMSMessage(data));
            }
            ...
            this.messageListView1.LbChoice.Sorted = true;
        }
